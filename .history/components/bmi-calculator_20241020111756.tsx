...
export default function BmiCalculator() {
  ...
  const calculateBmi = (): void => {
    if (!height || !weight) {
      setError("Error! solution :need to enter height as well as weight."); // Alert if either input is empty
      return;
    }
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-100 dark:bg-blue-700">
      ...
      <Card className="w-full max-w-md mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Enter your height & weight to calculate your BMI.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {error && <div className="text-maroon-500 text-center">{error}</div>}
          {/* Display BMI result if available */}
          {result && (
            <div className="grid gap-2">
              <div className="text-center text-3xl font-semibold">{result.bmi}</div>
  ...
  <p className="text-sm text-gray-400 dark:text-r-400 font-semibold mb-0">
