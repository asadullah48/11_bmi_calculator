        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              className="bg-gray-700 text-white placeholder-brown-400 border border-gray-600 rounded-md focus:border-indigo-500 focus:ring-indigo-500 focus:ring-1 transition"
            />
          </div>
